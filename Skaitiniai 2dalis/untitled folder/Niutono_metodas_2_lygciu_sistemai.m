...
mesh(x,y,Z(:,:,2)','FaceAlpha',0.22,'FaceColor','b','EdgeColor','b');contour(x,y,Z(:,:,2)',[0 0],'LineWidth',1.5,'LineColor','b');
...
figure(1);plot3(x1(1),x1(2),0,'g*');line([x(1),x1(1)],[x(2),x1(2)],[0,0],'Color','green');
